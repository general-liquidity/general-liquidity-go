...
const (
	...
	MEMORY_RECORDED WebhookEventType = "memory.recorded"
	MEMORY_TAINTED WebhookEventType = "memory.tainted"
	MEMORY_ERASED WebhookEventType = "memory.erased"
	MEMORY_CONSOLIDATED WebhookEventType = "memory.consolidated"
