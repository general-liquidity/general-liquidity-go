...
type Problem struct {
	...
	// Stable machine code an agent branches on, e.g. \"over_mandate\" | \"rate_limited\". The memory group adds: \"memory.denied\" (403, engine refused a gated write), \"memory.forbidden\" (403, mandate scope/capability refusal), and \"memory.pending\" (202, write parked for operator confirmation). 
