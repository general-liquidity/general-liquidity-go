...
// Problem RFC 7807 problem detail. For an agent the error IS the recovery instruction: `code` is a stable machine token to branch on and `retry_after` is a valid-retry hint. 
type Problem struct {
	...
	// Stable machine code an agent branches on, e.g. \"over_mandate\" | \"rate_limited\".
	Code *string `json:"code,omitempty"`
	// Valid-retry hint in seconds; absent when the call must not be retried as-is.
